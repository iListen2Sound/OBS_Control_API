...
namespace OBS_Control_API
{
	...
	public partial class OBS : MelonMod
	{
		...
		private void OnUISaved()
		{
			...
			{
				LogError($"Error reading config values: {e}");
			}
			...
			{
				LogError($"Error connecting to OBS: {e}");
				Disconnect();
			}
		...
		private void UpdateSFXvolume()
		{
			...
			if (null!=Confirmation) Confirmation.generalSettings = generalAudioSettings;
			if (null != Screenshot) Screenshot.generalSettings = generalAudioSettings;
			if (null != StartRecording) StartRecording.generalSettings = generalAudioSettings;
			if (null != StopRecording) StopRecording.generalSettings = generalAudioSettings;
		}
